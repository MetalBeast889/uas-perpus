...
<!-- Tombol tambah -->
<a href="admin.php?page=utama&panggil=tambah-kategori.php" class="btn btn-success mb-3">
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td>$nama</td>
                    <td>
                        <a href='?page=utama&panggil=tambah-kategori.php&edit=$id' class='btn btn-warning btn-sm'>Edit</a>
                        <a href='?page=utama&panggil=kategori.php&hapus=$id' class='btn btn-danger btn-sm' onclick=\"return confirm('Yakin hapus data ini?')\">Hapus</a>
                    </td>
                  </tr>";
            $no++;
        }
